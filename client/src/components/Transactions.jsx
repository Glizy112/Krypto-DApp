    ...
    return (
        ...
        >
            <div className="flex flex-col items-center w-full mt-3">
                <div className="w-full mb-6 p-2">            {/* Whenever using target _blank it's good to have rel set as below */}
    ...
    return (
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                {/* Latest Transactions*/}
                {/* If account not connected, then Connect your account to see the latest transactions */}
                { currentAccount 
                ? (
